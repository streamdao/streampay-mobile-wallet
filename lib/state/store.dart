...
class StateWrapper extends Store<AppState> {
  ...
  Future<void> createWatcher(String my_mnemonic) async {
    ...
    WalletAccount walletAccount =
    await WalletAccount.generate(my_mnemonic, "https://api.mainnet-beta.solana.com",accountName);
  ...
  Future<WalletAccount> createNewWallet(String accountName) async {
    ...
    WalletAccount walletAccount =
    await WalletAccount.generateNewWallet( "https://api.mainnet-beta.solana.com", nameValue, accountName);
