                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: SizedBox(
                            ...
                            // child: Text("strm5di...sdewDoS43", style: TextStyle(color: Color(0xff00264E), fontSize: 18, fontWeight: FontWeight.w400)),
                          ),
                        ),
                        SizedBox(height: 40,),
                        ...
                        Container(
                          ...
                          child: SizedBox(
                            ...
                            // child: Text("strm5ipdi...sdewDoS43", style: TextStyle(color: Color(0xff00264E), fontSize: 18, fontWeight: FontWeight.w400)),
                          ),
                        ),
                        SizedBox(height: 60,),
                        Container(
